...
public class SpringSecurityCourseApplication {
   ...
   /*
    ESTA PARTE SE UTILIZA PARA GENERAR CONTRASEÑAS PARA LA INSERCION DE USUARIOS CON ROLES QUE
    NO ESTAN ADMINISTRADOS EN LOS ENDPOINTS PUBLICOS, GENERA UNA CONTRASEÑA ENCRYPTADA POR LA CONFIGURACION
    DE SEGURIDAD Y FIRMA IMPLEMENTADA EN ESTE SISTEMA
    @Bean
